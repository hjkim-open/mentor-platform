...
const stats = [
  ...
  { value: '20명', label: '전문 코칭멘토진', sub: '각 분야 최고 전문가' },
  { value: '4.9★', label: '평균 평점', sub: '500+ 리뷰 기준' },
];

const testimonials = [
  {
    quote: '투자자 피칭을 앞두고 IR 덱을 완전히 재구성했어요. 코칭멘토 덕분에 Series A $15M을 클로징할 수 있었습니다.',
    author: '김민준',
    role: 'B2B SaaS 창업자',
    initials: '김민',
  ...
  {
    quote: '기술팀을 어떻게 꾸려야 할지 막막했는데, CTO 출신 코칭멘토와 3개월 코칭으로 개발팀 10명을 성공적으로 구성했습니다.',
    author: '이채영',
    role: '핀테크 창업자',
    initials: '이채',
  ...
  {
    quote: '일본 진출 전략을 세우는 데 현지 시장 경험이 풍부한 코칭멘토의 도움이 절대적이었습니다. 파트너십 5건을 동시에 클로징했어요.',
    author: '박도현',
    role: '커머스 플랫폼 창업자',
    initials: '박도',
...
export default function Stats() {
  ...
  return (
    <section id="stats" className="py-24 bg-[#1a1a1a]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {testimonials.map((t) => (
            <div key={t.author}
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-5 italic">"{t.quote}"</p>
              <div className="flex items-center gap-3">
                <div className={`w-10 h-10 rounded-xl ${t.accent} flex items-center justify-center`}>
