...
const programs = [
  {
    ...
    features: ['코칭멘토 1:1 세션', '핵심 문제 집중 논의', '실행 가능한 액션 아이템', '사전 자료 리뷰'],
    highlight: false,
  ...
  },
  {
    ...
    features: ['주 1회 1:1 세션 (60분)', '코칭멘토 직접 네트워크 연결', '투자자 IR 리뷰', '슬랙 수시 질문 지원', '월 그룹 세션 참가'],
    highlight: true,
  ...
  },
  {
    ...
    features: ['주 2회 1:1 세션', '멀티 코칭멘토 접근 가능', '보드 미팅 준비 지원', '채용 후보자 레퍼런스', '글로벌 네트워크 연결'],
    highlight: false,
  ...
  },
  {
    ...
    duration: '맞춤 설계',
    price: '협의',
    description: '해외 시장 진출을 목표로 하는 스타트업을 위한 특화 프로그램. 현지 코칭멘토와의 연결 포함.',
    features: ['해외 시장별 전문 코칭멘토', '현지 VC/파트너 미팅', '해외 법인 설립 지원', 'JP/SEA/US 네트워크', '글로벌 액셀러레이터 연결'],
    highlight: false,
